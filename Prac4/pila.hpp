...
/* Módulo que implementa el TAD pila genérica en memoria dinámica.
   Autores: profs. de la asignatura. 2022-10-17 (versión 3). 
*/
...
struct Pila {
    ...
    friend void siguienteYAvanza<T>(Pila<T>& p, T& e, bool& error);
 private:
...
*/
template<typename T> 
void siguienteYAvanza(Pila<T>& p, T& e, bool& error) {
